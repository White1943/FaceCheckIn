...
export const asyncRoutes = [
  ...
  },
  {
    ...
    redirect: 'noRedirect',
    name: 'Attendance',
    meta: { title: '签到管理', icon: 'check-circle' },
    children: [
      {
        path: 'records',
        name: 'AttendanceRecords',
        component: () => import('@/views/attendance/records/index'),
        meta: { title: '签到记录' },
      },
      {
        path: 'settings',
        name: 'AttendanceSettings',
        component: () => import('@/views/attendance/settings/index'),
        meta: { title: '签到设置' },
      },
      {
        path: 'statistics',
    ...
    children: [
      {
        path: 'list',
        name: 'StudentList',
        component: () => import('@/views/students/list/index'),
        meta: { title: '学生列表' },
      },
    ],
  },
